...
<aside class="sidebar" id="sidebar">
    <div class="sidebar-brand">
        <?php if ($logoExists): ?>
        <img src="<?= htmlspecialchars($shopLogo) ?>?v=<?= filemtime(__DIR__ . '/../' . $shopLogo) ?>" loading="lazy" alt="Logo" style="height:36px;width:36px;object-fit:contain;border-radius:6px;flex-shrink:0;">
        <?php else: ?>
